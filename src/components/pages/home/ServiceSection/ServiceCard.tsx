...
const ButtonMoreInfo = () => {
    return ( <button className="mx-auto my-2 text-blackout dark:text-white bg-secondary dark:bg-accent-secondary-button cursor-pointer w-2/3 p-3 rounded-2xl font-bold">
        More Info
    </button> );
}
...
const ServiceCard: React.FC<ServiceCardProps> = ({
    ...
    return ( <article className="border-solid border-[2px]
     border-primary-light dark:border-accent-border rounded-xl
     p-4 flex flex-col bg-white dark:bg-accent-light">
